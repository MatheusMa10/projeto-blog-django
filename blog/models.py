...
class Category(models.Model):
    ...
    name = models.CharField(max_length=255)
    slug = models.SlugField(
        null=True, blank=True, default=None, unique=True, max_length=255,
    )
...
class Page(models.Model):
    ...
    slug = models.SlugField(
        unique=True, null=True, blank=True, default=None, max_length=255
    )
...
class Post (models.Model):
    ...
    title = models.CharField(max_length=255)
    slug = models.SlugField(
        unique=True, default="", null=True, blank=True, max_length=255
    )
    excerpt = models.CharField(max_length=150)
    is_published = models.BooleanField(
        default=False, help_text= 'Este campo precisará estar marcado para o post ser exibido publicamente.'
    )
    ...
    updated_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, blank=True, null=True, related_name= 'page_updated_by'
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if cover_changed:
            resize_image(self.cover, 500, True, 70)
