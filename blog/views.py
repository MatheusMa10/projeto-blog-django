...
class CreatedByListView(PostListView):
    ...
    def get_queryset(self):
        ...
        # qs = qs.filter(self.kwargs.get('author_pk'))
...
class CategoryListView(PostListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        page_title = f'{self.kwargs['slug']} - categoria - '.title()
...
class TagListView(PostListView):
    ...
    def get_context_data(self, **kwargs):
        ctx = super().get_context_data(**kwargs)
        page_title = f'{self.kwargs['slug']} - Tag - '.title()
...
#     page_title = f'{page_obj[0].tag.first().name} - tags - '
...
#     page_obj = Page.objects.filter(slug=slug, is_published=True).first()
